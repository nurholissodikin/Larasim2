...
<div class="content-wrapper">
        ...
        </div>@if(Session::has('alert-success'))
                  ...
                  <tbody>
                   @foreach($jurusan as $data)
                        ...
                        <form action="{{route('jurusan.destroy',$data->id)}}" method="post">
                            ...
                            <input type="submit" class="btn btn-danger" onclick=" return confirm('Apakah anda yakin akan menghapus data ?');" value="Hapus">
                                {{csrf_field()}}
                            </td>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header btn-primary">
                ...
                <h4 class="modal-title">Isi Data Jurusan</h4>
              </div>
